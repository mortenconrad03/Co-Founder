...
export const Logo = ({ size = "sm" }: { size?: string }) => React.createElement("img", { src: '/logo.png', alt: "CoFounder AI", style: { height: size === "lg" ? 48 : size === "md" ? 36 : 28, width: "auto", objectFit: "contain", filter: "var(--logo-filter)" } });
